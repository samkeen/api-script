...
Failure Summary:
	...
	[tests.fenphen.yaml#GET all robot]	"The HTTP response code for this GET request [http://localhost/service1/?_wrap_array=1&__c=/api/v1/robot] should have been 200, was instead: [404]
...
The HTTP response code for this GET request [http://localhost/service1/?_wrap_array=1&__c=/api/v1/robot] should have been 200, was instead: [404]
Response __error: Array
(
    [message] => Resource robot is not known
    [type] => invalid_request
...
Constructed full URI: http://localhost/service1/?_wrap_array=1&__c=/api/v1/product
...
Constructed full URI: http://localhost/service1/?_wrap_array=1&__c=/api/v1/product/634
...
Constructed full URI: http://localhost/service1/?_wrap_array=1&__c=/api/v1/product/636
Asserted expected Response code [204] matched recieved: 204
Asserted response body was empty
Passed
-------------
Running GET Test: 'GET all tag' (just ensure the get all URL, '/tag' returns 200)
Constructed full URI: http://localhost/service1/?_wrap_array=1&__c=/api/v1/tag
Response Body: []
...
-------------
Running GET Test: 'GET all robot' (just ensure the get all URL, '/robot' returns 200)
Constructed full URI: http://localhost/service1/?_wrap_array=1&__c=/api/v1/robot
Response Body: {"__error":{"message":"Resource robot is not known","type":"invalid_request","validation":null},"__dev-mode-log-stack":null,"__dev-mode-stack-trace":[{"file":"\/Users\/sam\/Projects\/service1\/src\/vendor\/saccharin\/src\/run.php","line":192,"function":"response_error","class":"Saccharin\\Util\\Http","type":"::","args":[{}]},{"file":"\/x\/service1\/index.php","line":82,"args":["\/Users\/sam\/Projects\/service1\/src\/vendor\/saccharin\/src\/run.php"],"function":"require"}]}
